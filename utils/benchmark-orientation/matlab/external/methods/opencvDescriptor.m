%%% opencvDescriptor.m --- 
%% 
%% Filename: opencvDescriptor.m
%% Description: 
%% Author: Kwang Moo Yi, Yannick Verdie
%% Maintainer: Kwang Moo Yi
%% Created: Wed Jun 29 13:44:54 2016 (-0700)
%% Version: 
%% Package-Requires: ()
%% URL: 
%% Doc URL: 
...
function [com] = opencvDescriptor(method_name, in_file_name, kp_file_name, out_file_name, p)
    ...
    detector_path = [rootFolder '/external/methods/opencvDescriptor'];
