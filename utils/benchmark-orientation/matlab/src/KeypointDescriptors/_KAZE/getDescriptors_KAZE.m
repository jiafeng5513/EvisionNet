...
function [feat,desc,metric] = getDescriptors_KAZE(img_info, kp_file_name, orientation_file_name, p)
    %here reject some kp
    listMethodsOK = {'KAZE'}; %KAZE can only take KAZE
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% getDescriptors_KAZE.m ends here
