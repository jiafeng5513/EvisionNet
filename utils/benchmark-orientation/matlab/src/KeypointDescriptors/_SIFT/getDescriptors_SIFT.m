...
% Version: 
% Package-Requires: ()
% Last-Updated: Wed Jun 29 09:30:01 2016 (-0700)
%           By: Kwang Moo Yi
%     Update #: 9
% URL: 
% Doc URL: 
...
function [feat,desc,metric] = getDescriptors_SIFT(img_info, kp_file_name, orientation_file_name, p)
    
    %here reject some kp
    listMethodsOK = {'SIFT','EdgeFociD','SIFTMult', ...
                     'EdgeFociDMult'};
