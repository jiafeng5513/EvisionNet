...
%% 
%% Filename: getDescriptors_ORB.m
%% Description: 
%% Author: Kwang Moo Yi, Yannick Verdie
%% Maintainer: Kwang Moo Yi
%% Created: Thu Jun 16 17:48:08 2016 (+0200)
%% Version: 
%% Package-Requires: ()
%% URL: 
%% Doc URL: 
...
function [feat,desc,metric] = getDescriptors_ORB(img_info, kp_file_name, orientation_file_name, p)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% getDescriptors_ORB.m ends here
