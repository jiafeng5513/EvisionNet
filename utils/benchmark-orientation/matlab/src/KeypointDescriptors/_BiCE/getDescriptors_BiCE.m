...
function [feat,desc,metric] = getDescriptors_BiCE(img_info, kp_file_name, orientation_file_name, p)
    %here reject some kp
    listMethodsOK = {'EdgeFociB','EdgeFociBMult'};
    ...
    if ~exist(out, 'file')% || forceRecomputeNoSave
        ...
        com = originalEdgeFociDescriptor( in, kpf2, out,p);
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% getDescriptors_BiCE.m ends here
