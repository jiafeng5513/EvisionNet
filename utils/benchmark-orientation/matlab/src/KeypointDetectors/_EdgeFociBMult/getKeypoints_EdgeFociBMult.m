...
% 
% Filename: getKeypoints_EdgeFociBMult.m
% Description: Wrapper Function for EdgeFoci with Multiple Orientations to
%              be used with BiCE
...
function [keypts] = getKeypoints_EdgeFociBMult(img_info, p)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% getKeypoints_EdgeFociBMult.m ends here
