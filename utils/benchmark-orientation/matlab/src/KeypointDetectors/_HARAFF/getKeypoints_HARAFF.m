...
% 
% Filename: getKeypoints_HARAFF.m
% Description: Wrapper Function for HARAFF
% Author: Kwang Moo Yi, Yannick Verdie
% Maintainer: Kwang Moo Yi, Yannick Verdie
% Created: Thu Oct  8 17:24:23 2015 (+0200)
% Version: 
% Package-Requires: ()
% URL: 
% Doc URL: 
...
function [keypts] = getKeypoints_HARAFF(img_info, p)
    ...
    if ~exist(out, 'file')
        ...
        [feat,~,INFO] = vl_covdet(single(in),'method','HarrisLaplace','DoubleImage',false,'EstimateOrientation', true, 'EstimateAffineShape', true);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% getKeypoints_HARAFF.m ends here
