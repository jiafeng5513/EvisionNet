# -*- coding:UTF-8 -*-
import sys
import UI.EvisionNet_GUI  # TODO: Change according to the file name of the main window
...
class EvisionNetGUI(QMainWindow):
    def __init__(self):
        ...
        self.ui = UI.EvisionNet_GUI.Ui_MainWindow()
        self.ui.setupUi(self)
        # signal and solts
        self.signals_handler()

    def signals_handler(self):
        self.ui.pushButton_browse.clicked.connect(self.OnPushed_broswer)
        pass
